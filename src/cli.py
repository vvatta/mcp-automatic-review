...
app = typer.Typer(
    name="mcp-sandbox", help="Comprehensive MCP malware sandbox with layered security architecture"
)
console = Console()
...
@app.command()
def scan(workspace: str = typer.Argument(..., help="Path to scan")) -> None:
    """
